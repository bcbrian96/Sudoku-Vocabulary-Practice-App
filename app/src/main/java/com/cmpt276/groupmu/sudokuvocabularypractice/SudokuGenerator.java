...
public class SudokuGenerator {
    ...
    boolean setBoxes(int rowIndex, int colIndex){
        ...
        for (int i =1; i <=sizeOfPuzzle;i++){
            if (checkDuplicateInPuzzle(rowIndex,colIndex,i)){
                ...
                if (setBoxes(rowIndex,colIndex+1)) return true;
    ...
    public void emptyTheCells()
    {
        ...
        while (countNum != 0)
        {
            int emptyCell = random(sizeOfPuzzle*sizeOfPuzzle);
